...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 19 Haz 2026, 15:14:53
...
(3, 'Huzur', 390, 2, 1, 1),
(4, 'Saatleri Ayarlama Enstitüsü', 350, 2, 1, 1),
(5, 'İnce Memed', 450, 3, 1, 2),
(6, 'Yer Demir Gök Bakır', 300, 3, 1, 2),
(7, 'Aşk-ı Memnu', 320, 4, 1, 3),
(8, 'Çalıkuşu', 400, 5, 1, 3),
(9, 'Sinekli Bakkal', 350, 7, 1, 3),
(10, 'Tutunamayanlar', 724, 10, 1, 4),
(11, 'Kürk Mantolu Madonna', 160, 1, 1, 1),
(12, 'Kuyucaklı Yusuf', 220, 1, 1, 1),
(13, 'Huzur', 390, 2, 1, 1),
(14, 'Saatleri Ayarlama Enstitüsü', 350, 2, 1, 1),
(15, 'İnce Memed', 450, 3, 1, 2),
(16, 'Yer Demir Gök Bakır', 300, 3, 1, 2),
(17, 'Aşk-ı Memnu', 320, 4, 1, 3),
(18, 'Çalıkuşu', 400, 5, 1, 3),
(19, 'Sinekli Bakkal', 350, 7, 1, 3),
(20, 'Tutunamayanlar', 724, 10, 1, 4);
...
(11, 1, 'Ahmet', '2026-06-01'),
(12, 2, 'Ayşe', '2026-06-02'),
(13, 3, 'Mehmet', '2026-06-03'),
(14, 4, 'Fatma', '2026-06-04'),
(15, 5, 'Zeynep', '2026-06-05'),
(16, 6, 'Can', '2026-06-06'),
(17, 7, 'Deniz', '2026-06-07'),
(18, 8, 'Elif', '2026-06-08'),
(19, 9, 'Burak', '2026-06-09'),
(20, 10, 'Selin', '2026-06-10');
...
(15, 'Reşat Nuri Güntekin'),
(16, 'Peyami Safa'),
(17, 'Halide Edip Adıvar'),
(18, 'Orhan Kemal'),
(19, 'Tarık Buğra'),
(20, 'Oğuz Atay');
...
--
ALTER TABLE `oduncalanlar`
  MODIFY `OduncID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- Tablo için AUTO_INCREMENT değeri `yayinevleri`
--
ALTER TABLE `yayinevleri`
  MODIFY `YayineviID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- Tablo için AUTO_INCREMENT değeri `yazarlar`
--
ALTER TABLE `yazarlar`
  MODIFY `YazarID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
